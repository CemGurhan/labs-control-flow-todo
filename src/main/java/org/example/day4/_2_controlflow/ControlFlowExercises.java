...
public class ControlFlowExercises {
    ...
    int sum(int a, int b, int c) {
        ...
        }else if((a+c)%c==0 && (a+c)%a==0){

            return a+b;

        }else if((b+c)%b==0 && (b+c)%c==0){

            return a+c;

        }else if((a+b)%b==0 && (a+b)%a==0){
    ...
    String canParty(int day, boolean vacation) {
        if((day<=4 || day==7) && vacation==false){

            return "Don't party";

        }
        else if((day==5 || day==6) && vacation==false){

            return "Party till midnight";

        }
        else if((day<=4 || day==7) && vacation==true){
